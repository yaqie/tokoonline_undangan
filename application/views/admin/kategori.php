                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form id="form_kategori" action="<?= base_url('p_admin/kategori') ?>" method="post">
                                ...
                                <div class="form-group">
                                    <select class="select2 form-control custom-select" name="kategori_master" style="width: 100%; height:36px;" required>
                                      <option value="">Pilih Kategori Master</option>
                                      <?php foreach ($kategori_master as $km): ?>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  ...
                                  $no++;
                                  $nmk = $this->m_data->select_where(array('id_kategori' => $k->id_parent),'kategori')->row();
                                  ?>
