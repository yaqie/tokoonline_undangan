              ...
              <?php echo $this->session->flashdata('message');?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Semua data permintaan verifikasi akun</h4>
                                <h6 class="card-subtitle">Semua (<?= $semua ?>)</h6>
                            </div>
                            <!-- <hr> -->
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('ktp/'.$u->gambar_ktp) ?>" target="_blank">Lihat Gambar</a></td>
                                                <td>
                                                    <a href="<?= base_url('p_admin/validasi_akun/'.$u->id_user) ?>" onclick="return confirm('Anda yakin ingin mengaktivasi akun <?= $u->nama ?> ?')" class="btn btn-success"><i class="fa fa-check"></i> Aktivasi</a>
                                                </td>
                                            </tr>
