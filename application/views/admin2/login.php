...
<body class="hold-transition login-page" style="background-image: linear-gradient(to bottom, #b1f0ef, #2424c9);height:auto;">
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url('assets/admin2/') ?>index2.html"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Masuk Untuk Memulai Sesi Anda</p>

    <form action="<?= base_url('p_admin/login') ?>" method="post">
...
<!-- iCheck -->
<script src="<?= base_url('assets/admin2/') ?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
