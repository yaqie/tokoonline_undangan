				...
				<div class="row">
						<div class="col-lg-12">
								...
								<div class="account-wall">
										...
										<h1 class="login-title"><span>Selamat</span> Datang <small> Silahan masuk untuk memulai sesi anda</small></h1>
										</section>
										<form class="form-signin" action="<?= base_url('p_user/login')?>" method="post">
											<?php echo $this->session->flashdata('message');?>
												...
												<section>
														...
														<button class="btn btn-lg btn-theme-inverse btn-block" type="submit" id="sign-in" style="background:#EB3E32;border:0px solid;">Masuk</button>
												</section>
												...
												<a class="btn btn-lg  btn-inverse btn-block" href="<?= base_url('user/daftar'); ?>" type="button"> Akun Baru </a>
										</form>
